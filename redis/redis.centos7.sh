...
#     ./redis.centos7.sh $1 $2 $3 $4
#     ./redis.centos7.sh init 4.0.14 8.8.8.8 6379
...
init(){
    ...
    userdel -r redis
    yum -y install openssl-devel make gcc wget curl vim lrzsz
    base_dir="/home/redis"
    ...
    echo "sentinel leader-epoch mymaster 1"                                                                                                           >> $redis_sentinel_config_file
