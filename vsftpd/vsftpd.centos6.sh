...
init(){
    ...
    echo "auth    required /lib64/security/pam_userdb.so db=/etc/vsftpd/virtual_user" > /etc/pam.d/vsftpd
    echo "account required /lib64/security/pam_userdb.so db=/etc/vsftpd/virtual_user" >> /etc/pam.d/vsftpd
