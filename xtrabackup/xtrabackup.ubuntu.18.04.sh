...
# 安装xtrabackup
# ./xtrabackup.ubuntu.18.04.sh init 24
# 全库全量备份
# ./xtrabackup.ubuntu.18.04.sh backup_all_database
# 全库全量恢复
# ./xtrabackup.ubuntu.18.04.sh recovery_all_database 20200101
# 全库增量备份
# ./xtrabackup.ubuntu.18.04.sh incremental_backup_of_all_database
# 全库增量恢复
# ./xtrabackup.ubuntu.18.04.sh incremental_recovery_of_all_database 20200101 7
# 单库全量备份
# ./xtrabackup.ubuntu.18.04.sh backup_a_single_database "database name"
# 单库全量恢复
# ./xtrabackup.ubuntu.18.04.sh recovery_a_single_database 20200101 "database name"
# 单库增量备份
# ./xtrabackup.ubuntu.18.04.sh incremental_backup_of_a_single_database "database name"
# 单库增量恢复
# ./xtrabackup.ubuntu.18.04.sh incremental_recovery_of_a_single_database 20200101 "database name" 7
...
init(){
    ...
    sudo apt -y install "percona-xtrabackup-$1"
}
